...
import com.example.rps.databinding.ActivityPlayerToPlayerBinding;

public class PlayerToPlayer extends AppCompatActivity {

    private ActivityPlayerToPlayerBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPlayerToPlayerBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        getPlayersName();

        binding.btnP2rock.setOnClickListener(v -> onPlayP2("rock"));
        binding.btnP2paper.setOnClickListener(v -> onPlayP2("paper"));
        binding.btnP2scissor.setOnClickListener(v -> onPlayP2("scissor"));
        binding.btnP1rock.setOnClickListener(v -> onPlayP1("rock"));
        binding.btnP1paper.setOnClickListener(v -> onPlayP1("paper"));
        binding.btnP1scissor.setOnClickListener(v -> onPlayP1("scissor"));
    }
    ...
    private void getPlayersName() {
        ...
        Button btnOk = nameDialog.findViewById(R.id.btnOk);
        btnOk.setOnClickListener(v -> {
            EditText etName1 = nameDialog.findViewById(R.id.et_name1);
            EditText etName2 = nameDialog.findViewById(R.id.et_name2);
            CharSequence name1 = etName1.getText();
            CharSequence name2 = etName2.getText();
